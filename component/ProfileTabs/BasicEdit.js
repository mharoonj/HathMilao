...
export default class StackedLabelExample extends Component {
  ...
  onSubmit() {
    ...
    Edit_Basic(data)
      .then(async response => {
        const { city, country, headline, summary, phonenumber } = this.state;
        if (city && country && headline && summary && phonenumber) {
          this.setState({ visible: false });
          console.log("success");
          ...
          this.setState({ visible: false });
          DangerToast("Please Fill all fields then update");
        }
      })
      .catch(e => {
        this.setState({ visible: false });
        if (e.response) {
          ...
          DangerToast("Image size too large");
        }
      });
  }
